    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (op == 1)
                {
                    if (DegreeProgram.programList.Count > 0)
                    {
        ...
        static STUDENT addStudent()
        {
            ...
            for (int x = 0; x < no; x++)
            {
                ...
                bool flag = false;
                foreach (DegreeProgram d in DegreeProgram.programList)
                {
                    if (nam == d.programTitel && !(DegreeProgram.prefference.Contains(d))) ;
                    {
                        DegreeProgram.prefference.Add(d);
                        flag = true;
                    }
                }
                if (flag == false)
            ...
            STUDENT s = new STUDENT(name, age, matric, fsc, ecat, DegreeProgram.prefference);
            return s;
        }
        ...
        static void availableDegreeProgram()
        {
            ...
            foreach (DegreeProgram a in DegreeProgram.programList)
            {
        ...
        {
            DegreeProgram. programList.Add(a);
        }
        ...
        static List<STUDENT> sortStudentByMerit()
        {
            ...
            sortedStudentList = STUDENT.studentList.OrderByDescending(o => o.merit).ToList();
